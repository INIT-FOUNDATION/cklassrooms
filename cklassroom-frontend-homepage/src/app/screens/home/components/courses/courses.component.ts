...
export class CoursesComponent implements AfterViewInit {
  ...
  getCourseList: any = [
    ...
    },
    {
      ...
      img: 'htmlCssJs',
      h1: 'MEAN stack employs JavaScript throughout the development process, from server to client, streamlining communication and reducing context-switching overhead',
      h2: 'With Node.js and MongoDB\'s non-blocking architecture, MEAN stack applications can easily handle a large number of concurrent users, making it ideal for scalable solutions.',
      h3: 'MEAN stack\'s lightweight and modular nature allows for quick prototyping and iteration, enabling developers to swiftly turn ideas into functional prototypes.',
      h4: 'Being open-source technologies, the MEAN stack components benefit from extensive community support, offering a plethora of resources, libraries, and frameworks to expedite development.',
      color: '#f16529',
    },
    {
      id: 8,
