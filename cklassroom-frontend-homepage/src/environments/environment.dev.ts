...
export const environment = {
  ...
  meeting_prefix_url: `${BASE_URL}${API_VC_PORT}/api/v1/meeting`,
  ...
  app_link: {
    ...
    appStore:
      'https://itunes.apple.com/us/app/aieze-link/id1668022173?ls=1&mt=8',
  },
  socket_webinar_live_counter: `wss://wssbeta.aieze.in`,
